...
TIPS = [
    ...
    "SOUL.md is a style overlay below the active identity — customize it to shape behavior.",
    ...
    "SOUL.md does not replace the active identity; use it for communication and working style.",
    "SOUL.md is auto-seeded with a default style overlay on first run. Edit it to customize.",
