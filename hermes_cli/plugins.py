...
class PluginContext:
    ...
    def register_disabled_dashboard_provider(self, provider) -> None:
        """Removed dashboard extensions are ignored in the Tangyuge server fork."""
        logger.info(
            "Plugin '%s' dashboard provider ignored; dashboard surface is disabled.",
            self.manifest.name,
        )
