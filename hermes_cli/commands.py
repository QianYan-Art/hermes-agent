...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("start", "Acknowledge platform start pings without a reply", "Session",
               gateway_only=True),
    CommandDef("new", "Start a new session, return to global defaults, and delete the previous session", "Session",
               args_hint="[name]"),
    CommandDef("reset", "Start a new session but keep this session's model/provider/reasoning config", "Session",
               args_hint="[name]"),
    ...
    CommandDef("status", "Show session summary, token usage, and recap", "Session"),
    CommandDef("view", "Show live run state: running/queued/progress/waiting", "Session"),
