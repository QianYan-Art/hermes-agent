...
TRIMMED_TEST_TARGETS = (
    ...
    "tests/agent/test_context_resolution_sources.py",
    "tests/hermes_cli/test_cli_context_switch_fallback.py",
    "tests/agent/test_kimi_auxiliary_requests.py",
    ...
    "tests/gateway/test_model_switch_context_scope.py",
    ...
    "tests/tools/test_tts_remote_metadata.py",
