...
def _images_cache_dir() -> Path:
    """Return the configured image cache directory, creating parents as needed."""
...
def save_b64_image(
    ...
    *,
    ...
    """Decode base64 image data and write it under the image cache directory.
...
def save_url_image(
    ...
    *,
    ...
    """Download an image URL and write it under the image cache directory.
